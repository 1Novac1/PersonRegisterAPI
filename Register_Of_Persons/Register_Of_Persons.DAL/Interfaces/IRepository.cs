...
namespace Register_Of_Persons.DAL.Interfaces
{
    public interface IRepository<T> where T : class
    {
        /// <summary>
        /// Adds <see langword="T"/> to the Database
        /// </summary>
        /// <param name="entity"></param>
        /// <returns><see langword="T"/> added record</returns>
        T Add(T entity);
        /// <summary>
        /// Removes <see langword="T"/> from the Database
        /// </summary>
        /// <param name="entity"></param>
        ...
        /// </summary>
        /// <param name="id"></param>
        /// <returns><see langword="T"/> record from table by id</returns>
        T GetById(int id);
        /// <summary>
